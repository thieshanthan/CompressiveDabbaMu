...
from modules.train_utils_segmentation import train
...
def run(config_file=None, opts=None, save_special=False, save_dir_special= None):
    ...
    trainset, valset, testset = get_dataset_func(img_size= img_size, delta= delta, num_samples_train= num_samples_train, data_dir= data_dir)
